...
********************************************
ROMBEG		EQU	EPROM_4		; ROM START ASSEMBLY ADDRESS
RAMOFS		EQU	-$1900		; ROM OFFSET TO RAM WORK PAGE
ROMSIZ		EQU	2048		; ROM SIZE
ROM2OF		EQU	ROMBEG-ROMSIZ	; START OF EXTENSION ROM
ACIA		EQU	ACIA01_Status	; DEFAULT ACIA ADDRESS
PTM		EQU	TIMER		; DEFAULT PTM ADDRESS
...
WORKPG		EQU	SYSRAM		; SETUP DIRECT PAGE ADDRESS
...
ROM2WK		EQU	*		; EXTENSION ROM RESERVED AREA
		ORG	*-21
TSTACK		EQU	WORKPG-$100	; TEMPORARY STACK HOLD
STACK		EQU	WORKPG-$100	; START OF INITIAL STACK
...
BLDNUM		LDA	#SP		; ALLOW LEADING BLANKS
